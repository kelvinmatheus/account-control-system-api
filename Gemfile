...
gem 'api-pagination'                                                              # Paginate in your headers, not in your response body. This follows the proposed RFC-5988 standard for Web linking. Read more: https://github.com/davidcelis/api-pagination
